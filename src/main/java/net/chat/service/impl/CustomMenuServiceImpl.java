...
public class CustomMenuServiceImpl implements CustomMenuService {
	...
	/* (non-Javadoc)
	 * @see net.chat.service.impl.CustomMenuService#findCustomMenuById(java.lang.Long)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.chat.service.impl.CustomMenuService#findCustomMenuByAccountId(java.lang.Long)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.chat.service.impl.CustomMenuService#save(net.chat.domain.WxCustomMenu)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.chat.service.impl.CustomMenuService#findParentMenuByAccountId(java.lang.Long)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.chat.service.impl.CustomMenuService#checkCustomMenu(net.chat.domain.WxCustomMenu)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.chat.service.impl.CustomMenuService#findChildMenuByAccountId(java.lang.Long)
	 */
	@Override
	public List<WxCustomMenu> findChildMenuByAccountId(Long accountId) {
		
		return dao.findChildMenuByAccountId(accountId);
	}
