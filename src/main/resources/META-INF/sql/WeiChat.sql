...
delete from `wx_game`;
INSERT INTO `wx_game` (id,name,url,note,gtype) VALUES (1,'聊天机器人','autoreply.jsp','一上一下','program');
INSERT INTO `wx_game` (id,name,url,note,gtype) VALUES (2,'刮刮乐','game_ggl.jsp','刮刮乐','html5游戏');
COMMIT;
