			...
			<td><table width="960" border="0" align="center" cellpadding="0"
					...
					<tr>
						<td height="555" background="${images}/di.jpg"><table
								...
								<tr>
									<td>${SPRING_SECURITY_LAST_EXCEPTION.message}
										<form action="j_spring_security_check" autocomplete="on"
											method="POST">
											<table width="90%" border="0" align="center" cellpadding="0"
												...
												<tr>
													...
													<td width="90%"><input id="username" name="username"
														class="full" required="required" type="text"
														placeholder="用户名 或者 mymail@mail.com" /></td>
												</tr>
												...
												<tr>
													<td width="10%"><img src="${images}/password.png"
														width="39" height="38" /></td>
													<td width="90%"><input id="password" name="password"
														class="full" required="required" type="password"
												...
												<tr>
													<td colspan="2"><table width="100%" border="0"
															...
															<tr>
																...
																<td width="43%">
																	<div align="right">
																		<input type="image" id="submitbtn"
																			src="${images }/bt_n.jpg" width="76" height="40" />
																	</div>
																</td>
															</tr>
