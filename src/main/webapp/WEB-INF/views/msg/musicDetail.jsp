...
<script type="text/javascript">
	$(document).ready(function() {
		$("#submitbtn").click(function() {
			$('#form1').attr('action', '${ctx}/message/sumitmusic');
			$('#form1').submit();
		});
	});
</script>
...
<body>
	<form:form id="form1" method="post" modelAttribute="musicForm">
											...
											<table width="100%" border="0" cellspacing="0"
												...
												<tr>
													...
													<td width="770" valign="top"><table width="96%"
															...
															<tr>
																<td height="40"><table width="100%" border="0"
																		...
																		<tr>
																			...
																			<td><label for="textfield"></label> <form:input
																					path="title" /> 必须</td>
																			<td class="biao">音乐地址（URL）</td>
																			<td><form:input path="musicUrl" size="40" />
																		</tr>
																		<tr>
																			<td height="40" class="biao">高清音乐地址（URL）</td>
																			<td><form:input path="hqmusicUrl" size="45" /></td>
																			<td class="biao">必须</td>
																			<td>必须</td>
																		</tr>
																	</table></td>
																						...
																						<td height="260"><table width="90%"
																								...
																								<tr>
																									<td height="200" valign="top"><form:textarea
																											path="description" cols="80" rows="14" /> 必须</td>
																								</tr>
																							</table></td>
																					</tr>
															...
															<tr><td><form:errors path="title" cssClass="error" /></td></tr>
																<tr><td><form:errors path="musicUrl" cssClass="error" /></td></tr>
																<tr><td><form:errors path="hqmusicUrl" cssClass="error" /></td></tr>
																<tr><td><form:errors path="description"	cssClass="error" /></td></tr>
