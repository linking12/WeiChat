		...
		$(document).ready(function() {
			var options = {
					...
					success : function(data, statusText, xhr, $form) {
						parent.location.href = "${ctx}/mallset/category?mallId="+data;
...
<body>
	...
	<form:hidden path="mallId" />
		<table width="96%" border="0" align="center" cellpadding="0" cellspacing="0">
			<tr>
				<td width="20%" height="40" class="biao">类别名称&nbsp;<font color="red">*</font></td>
				<td>
					<form:input path="categoryName" style="width: 300px;" class="required"/>
				</td>
			</tr>
			<tr>
				<td width="20%" height="40" class="biao">样式<font color="red">*</font></td>
				<td><form:radiobuttons items="${styles }" path="style" itemValue="key" itemLabel="value" class="required"/>
			...
			<tr>
				...
				<td>
					<form:textarea path="description" cols="45" rows="10" class="required"/>
