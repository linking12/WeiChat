											...
											<form:form id="accountForm" method="post"
												...
												<tr>
													<td height="40"><table width="100%" border="0"
															...
															<tr>
																...
																<td width="52%"><form:hidden path="id" /> <form:input
																		style="width: 300px;" path="name" /> 必须</td>
															...
															<tr>
																...
																<td width="52%"><form:input path="seq"
																		style="width: 300px;" readOnly="true" /></td>
															</tr>
														</table></td>
												</tr>
												...
												<tr>
													<td height="50"><input type="image" name="submit"
														...
														height="40" /></td>
													<td height="50"><form:errors path="name"
															cssClass="error" /></td>
												</tr>
											</form:form>
										</table>
