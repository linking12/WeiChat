...
import net.chat.integration.vo.AccessToken;
...
public class MenuManager {
	...
	public static void main(String[] args) {
		...
		// 调用接口获取access_token
		AccessToken at = WeiChatUtil.getAccessToken(appId, appSecret);

		if (null != at) {
			// 调用接口创建菜单
			int result = WeiChatUtil.createMenu(getMenu(), at.getToken());
